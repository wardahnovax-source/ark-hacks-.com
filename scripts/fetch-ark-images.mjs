...
import { buildOverlaySvg } from './ark-hack-overlays.mjs';
...
const KEYWORD_ASSETS = [
	{
		...
		url: `${ME_G}/escape-from-ark-screenshots_wjkx.1400.jpg`,
		overlay: 'hero',
	},
	{
		file: 'ark-hacks-aimbot.webp',
		url: `${ME}/escape-from-ark-screenshots_wjb1.1400.jpg`,
		overlay: 'aimbot',
	},
	{
		file: 'ark-hacks-esp-wallhack.webp',
		url: `${ME}/escape-from-ark-screenshots_55fp.1400.jpg`,
		overlay: 'wallhack',
	},
	{
		file: 'ark-squad-fight.webp',
		url: `${ME}/escape-from-ark-screenshots_67cp.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'ark-hacks-package.webp',
		url: `${ME}/escape-from-ark-screenshots_anf4.1400.jpg`,
		overlay: 'menu',
	},
	{
		file: 'ark-hacks-cover.webp',
		url: `${ME}/escape-from-ark-screenshots_7pr8.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'ark-header-art.webp',
		url: `${ME}/escape-from-ark-screenshots_c36j.1400.jpg`,
		overlay: 'hero',
	},
	{
		file: 'ark-loadout-builder.webp',
		url: `${NL}/escape-from-ark-screenshots_e5gw.1400.jpg`,
		overlay: 'menu',
	},
	{
		file: 'ark-battle-royale-combat.webp',
		url: `${ME}/escape-from-ark-screenshots_4h92.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'ark-base raid-fight.webp',
		url: `${BR}/goulag-inside_zusa.1400.png`,
		overlay: 'base raid',
	},
	{
		file: 'ark-player-esp.webp',
		url: `${ME}/escape-from-ark-screenshots_rb92.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'ark-scav-run-combat.webp',
		url: `${BR}/plunder_px6d.1400.png`,
		overlay: 'scav-run',
	},
	{
		file: 'ark-scav-run-mode.webp',
		url: `${BR}/parachuting_qhh2.1400.png`,
		overlay: 'loot',
	},
	{
		file: 'ark-verdansk-map.webp',
...
async function generateBrandAssets(heroBuffer) {
	...
	await writeFile(path.join(imagesDir, 'ark-hacks-logo.webp'), logoBuffer);
...
for (const asset of KEYWORD_ASSETS) {
	...
	try {
		...
		saved++;
		if (asset.file === 'ark-hacks-hero.webp') heroBuffer = webp;
	} catch (err) {
...
console.log(`\nDone — ${saved}/${KEYWORD_ASSETS.length} ARK hacks images (IGN base + ESP/aimbot overlays).`);
