...
export const phrases = {
	es: {
		buy: 'Comprar ARK Hacks', undetected: 'indetectables', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'Contacta support@arkhacks.com para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter ARK Hacks', undetected: 'indétectables', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'Contactez support@arkhacks.com pour le support ou les demandes légales.',
	},
	de: {
		buy: 'ARK Hacks kaufen', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkhacks.com für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar ARK Hacks', undetected: 'indetectáveis', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'Contacte support@arkhacks.com para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista ARK Hacks', undetected: 'indetectable', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'Contatta support@arkhacks.com per supporto o richieste legali.',
	},
	nl: {
		buy: 'ARK Hacks kopen', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkhacks.com voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup ARK Hacks', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkhacks.com w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить ARK Hacks', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkhacks.com для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'ARK Hacks satın al', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'Destek ve yasal sorular için support@arkhacks.com.',
	},
	ar: {
		buy: 'اشترِ ARK Hacks', undetected: 'غير مكتشف', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkhacks.com للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'ARK Hacksを購入', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'サポート・法務: support@arkhacks.com',
	},
	ko: {
		buy: 'ARK Hacks 구매', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => '지원 및 법무: support@arkhacks.com',
	},
	zh: {
		buy: '购买 ARK Hacks', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => '支持与法务：support@arkhacks.com',
	},
	hi: {
		buy: 'ARK Hacks खरीदें', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'सहायता: support@arkhacks.com',
	},
	id: {
		buy: 'Beli ARK Hacks', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkhacks.com untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ ARK Hacks', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkhacks.com สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua ARK Hacks', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkhacks.com cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити ARK Hacks', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkhacks.com для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit ARK Hacks', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkhacks.com pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără ARK Hacks', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkhacks.com pentru suport și legal.',
	},
	sv: {
		buy: 'Köp ARK Hacks', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkhacks.com för support och juridik.',
	},
};
