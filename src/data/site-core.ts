...
export const productInfo = {
	...
	features: {
		esp: [
			...
			'Dino ESP with tameable and alpha filters',
			'Item ESP and loot ESP markers',
			'Supply crate ESP highlights',
			'Skeleton ESP for players and dinos',
			'Boss ESP and alpha dino ESP',
		],
		aimbot: [
			'Aimbot with smooth aim and prediction',
			'FOV changer and aim assist tuning',
			'Bone priority and target selection',
			'Hotkeys mid-session',
			'Per-weapon profiles',
		],
		radar: [
			...
			'Rapid fire controls',
			'FOV changer and zoom',
			'Crosshair overlay',
			'Dino filters for carnivore, herbivore, and aggro',
		],
		general: [
