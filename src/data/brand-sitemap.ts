...
const defaultImages: BrandSitemapImage[] = [
	{
		...
		title: 'ark cheats esp',
		caption: 'ark cheats esp wallhack',
	},
	{
		src: '/images/ark-hacks-wallhack.webp',
		title: 'ark cheats wallhack',
		caption: 'ark cheats wallhack esp',
	},
	{
		src: '/images/ark-hacks-aimbot.webp',
		title: 'ark cheats aimbot',
		caption: 'ark cheats aimbot soft aim',
	},
	{
		src: '/images/ark-hacks-aimbot-view.webp',
		title: 'ark cheats aimbot',
		caption: 'ark cheats aimbot view',
	},
	{
		src: '/images/ark-hacks-radar.webp',
		title: 'ark cheats radar',
		caption: 'ark cheats radar hack',
	},
	{
		src: '/images/ark-hacks-raid.webp',
		title: 'ark cheats',
		caption: 'ark cheats in raid',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and aimbot in ARK', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'ark-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'ark-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	...
	updates: { title: '{primaryKeyword} live status', caption: 'Check {primaryKeyword} after a game or EAC patch' },
	...
	eac: { title: '{antiCheat} and {primaryKeyword}', caption: '{primaryKeyword} rebuilds after a EAC update' },
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for ARK: Survival Ascended on PC' },
